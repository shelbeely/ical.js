 ...
 */
export default function stringify(jCal: any[]): string {
 ...
 */
stringify.component = function(component: any[], designSet?: any): string {
 ...
 * @return {String}       The iCalendar/vCard string
 */
stringify.property = function(property: any[], designSet?: any, noFold?: boolean): string {
 ...
 */
stringify.paramPropertyValue = function(value: string, force?: boolean): string {
  if (!force &&
      (value.indexOf(',') === -1) &&
      (value.indexOf(':') === -1) &&
      (value.indexOf(';') === -1)) {
 ...
 */
stringify.multiValue = function(values: any[], delim: string, type: string, innerMulti: string | null, designSet: any, structuredValue?: any): string {
  let result = '';
 ...
 */
stringify.value = function(value: any, type: string, designSet: any, structuredValue: any): string {
