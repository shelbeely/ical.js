 ...
 */
parse.property = function(str: string, designSet?: any): any {
  let state = {
    component: [[], []],
 ...
 */
parse._handleContentLine = function(line: string, state: any): void {
 ...
 */
parse._parseMultiValue = function(buffer: string, delim: string, type: string, result: any[], innerMulti: string | null, designSet: any, structuredValue?: any): any {
  let pos;
  let lastPos = 0;
  let value;
  if (delim.length === 0) {
 ...
 */
parse._eachLine = function(buffer: string, callback: (err: string | null, line: string) => void): void {
