 ...
 */
export function updateTimezones(vcal: any): any {
 ...
 */
export function formatClassType(data: any, type: any): any {
 ...
 */
export function binsearchInsert(list: any[], seekVal: any, cmpfunc: (a: any, b: any) => number): number {
  if (!list.length)
    return 0;
